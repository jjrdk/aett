...
from aett_sqlite_async.tests.features.steps.Types import TestEvent, NestedEvent, NestedValue, DeepNestedValue
...
def step_impl(context):
    ...
    t = type(value)
    assert isinstance(value, DeepNestedValue), f"Expected DeepNestedValue, got {value}"
