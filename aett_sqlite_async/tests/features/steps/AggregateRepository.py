...
from aett_sqlite_async.tests.features.steps.Types import TestAggregate, TestEvent, TestMemento
from aett.domain import AsyncDefaultAggregateRepository
from aett.eventstore import EventMessage
from aett.sqliteasync import AsyncCommitStore, AsyncSnapshotStore
...
async def step_impl(context):
    ...
    for x in range(1, 10):
        ...
        async with aiosqlite.connect(context.db, autocommit=True) as conn:
