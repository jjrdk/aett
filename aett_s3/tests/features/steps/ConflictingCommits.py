...
from aett_s3.tests.features.steps.Types import TestEvent, TestEventConflictDelegate
...
def step_impl(context):
    ...
    context.store = CommitStore(s3_config=context.s3_config, conflict_detector=conflict_detector, topic_map=topic_map)
