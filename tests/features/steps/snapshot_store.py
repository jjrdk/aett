...
def step_impl(context):
    context.store = create_async_snapshot_store(connection_string=context.db, storage_type=context.storage_type)


@given("I have an snapshot store")
def step_impl(context):
    context.store = create_snapshot_store(connection_string=context.db, storage_type=context.storage_type)
