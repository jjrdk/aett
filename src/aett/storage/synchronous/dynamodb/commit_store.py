...
from aett.domain import ConflictDetector, DuplicateCommitException, ConflictingCommitException, \
...
class CommitStore(ICommitEvents):
    def __init__(self, topic_map: TopicMap,
        ...
        self._region = region
        self._dynamodb = _get_resource(profile_name=profile_name,
    ...
    def _item_to_commit(self, item: dict) -> Commit:
        return Commit(
            ...
            commit_stamp=datetime.datetime.fromtimestamp(int(item['CommitStamp']), datetime.timezone.utc),
