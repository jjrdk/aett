...
from aett.dyanmodb.Repositories import DynamoAggregateRepository
...
def step_impl(context):
    context.repository = DynamoAggregateRepository(str(uuid.uuid4()), CommitStore(region='localhost'))
